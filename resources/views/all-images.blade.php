              ...
              <tbody class="text-center">
                ...
                @endif
                  ...
                  <td class="col-md-3">
                   ...
                   <textarea class="form-control" rows="6" readonly> {{$wall->json_data}}</textarea>
                  ...
                  <td class="col-md-2">
                   ...
                   <a href="@if($wall->status=='sold') javascript:void(0) @else /delete/{{$wall->id}} @endif" class="btn btn-danger">Delete</a>
