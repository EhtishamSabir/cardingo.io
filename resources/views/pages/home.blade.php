        ...
        <div class="container max-w-5xl mx-auto m-8">
                        ...
                        <a href="">
                            <div class="flex flex-wrap flex-col lg:flex-row lg:mx-20 bg-gradient-to-br from-quinary to-senary rounded-2xl">
                                <div class="w-full text-white text-center lg:w-1/2 p-4 lg:p-20">
                                    <h2 class="mb-8 text-5xl font-goldplayBold">
                                        <img class="w-full" src="{{ asset('assets/images/logo-hoskeychains.png') }}" alt="Hoskeychains" />
                                    </h2>
                                    <p class="mb-8 md:mb-0">First collection of generative art by cardingo</p>
                                </div>
                                <div class="w-full lg:w-1/2">
                                    <img class="w-full rounded-b-2xl lg:rounded-bl-none lg:rounded-r-2xl" src="{{ asset('assets/images/slide1--cardingo-hoskeychains.gif') }}" alt="Cardingo to the moon!" />
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="">
                            <div class="flex flex-wrap flex-col lg:flex-row lg:mx-20 bg-gradient-to-br from-quinary to-senary rounded-2xl">
                                ...
                                <div class="w-full lg:w-1/2">
                                    <img class="w-full rounded-b-2xl lg:rounded-bl-none lg:rounded-r-2xl" src="{{ asset('assets/images/slide2--cardingo-hoskeychains.gif') }}" alt="hoskeychains"
                                    />
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide">
                        <a href="">
                            <div class="flex flex-wrap flex-col lg:flex-row lg:mx-20 bg-gradient-to-br from-quinary to-senary rounded-2xl">
                                ...
                                <div class="w-full lg:w-1/2">
                                    <img class="w-full rounded-b-2xl lg:rounded-bl-none lg:rounded-r-2xl" src="{{ asset('assets/images/slide3--cardingo-hoskeychains.gif') }}" alt="Cardingo to the moon!"
                                    />
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide">
                        <a href="">
                            <div class="flex flex-wrap flex-col lg:flex-row lg:mx-20 bg-gradient-to-br from-quinary to-senary rounded-2xl">
                                ...
                                <div class="w-full lg:w-1/2">
                                    <img class="w-full rounded-b-2xl lg:rounded-bl-none lg:rounded-r-2xl" src="{{ asset('assets/images/slide4--cardingo-hoskeychains.gif') }}" alt="Cardingo to the moon!"
                                    />
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide">
                        <a href="">
                            <div class="flex flex-wrap flex-col lg:flex-row lg:mx-20 bg-gradient-to-br from-quinary to-senary rounded-2xl">
                                ...
                                <div class="w-full lg:w-1/2">
                                    <img class="w-full rounded-b-2xl lg:rounded-bl-none lg:rounded-r-2xl" src="{{ asset('assets/images/slide5--cardingo-hoskeychains.gif') }}" alt="Cardingo to the moon!"
                                    />
                                </div>
                            </div>
                        </a>
            ...
            <div class="flex flex-wrap overflow-hidden sm:-mx-2 lg:-mx-3 some-list-counter-1 items">
                ...
                <div class="w-full overflow-hidden sm:my-2 sm:px-2 sm:w-1/2 md:w-1/3 lg:my-3 lg:px-3 lg:w-1/5 transform transition hover:scale-105 duration-300 ease-in-out item">
                    <a href="/view/{{$wall->id}}" class="text-white block">
                        <div class="">
                            <div class="bg-gradient-to-br from-quinary to-senary rounded-2xl">
                                ...
                                <div class="relative w-full pt-100p"> 
                                    <div class="fit-image-div">
                                        <img class="w-full h-full object-cover" src="{{ URL::to('/') }}/Uploads/{{$wall->url}}" alt="{{$wall->name}}">
                                    </div> 
                                </div>
                                <div class="p-4">
                                    <span class="block text-lg my-2">project: {{$wall->assets_name}}</span>
                                    <span class="block text-lg my-2">collection: 
                                    @if($wall->collection_name!='')
                                    {{$wall->collection_name}}
                                        @else 
                                            Not Provided
                                        @endif    
                                    </span>
                                    <span class="block text-lg my-2">Status: 
                                         @if($wall->status=='minted')
                                            Minted
                                        @else 
                                            Not Minted
                                        @endif
                                    ...
                                    <div class="flex flex-wrap flex-row">
                                        ...
                                        @endif
                                        @if($wall->attr_1=='' && $wall->attr_2=='' && $wall->attr_3=='' && $wall->attr_4=='' && $wall->attr_5=='')
                ...
                <div class="flex flex-wrap -mx-4 overflow-hidden mb-10">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--tom-advisor.png') }}" alt="Tom - Advisor" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--bricky-artist.png') }}" alt="Bricky - Artist" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--darz-artist.png') }}" alt="Darz - Artist" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--mari-artist.png') }}" alt="Mari - Artist" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--eth-dev.png') }}" alt="Eth - Dev" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--chico-dev.png') }}" alt="Chico - Dev" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--adam-advisor.png') }}" alt="Adam - Advisor" />
                        </div>
                        <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                            <img class="w-full rounded-3xl" src="{{ asset('assets/images/team--faz-research.png') }}" alt="Faz - Research" />
                        </div>
                        <div class="py-3">
                ...
                <div class="flex flex-wrap -mx-4 overflow-hidden mb-10">
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <a href="#" data-modal-trigger aria-controls="partner-modal" aria-expanded="false">
                            <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                                <img class="w-full" src="{{ asset('assets/images/partners--dingo-sanctuary.png') }}" alt="Dingo Discovery Sanctuary and Research Centre" />
                            </div>
                            <div class="py-3">
                    ...
                    <div class="my-4 px-4 overflow-hidden w-1/2 lg:w-1/4 text-center">
                        <a href="#" data-modal-trigger aria-controls="partner-modal" aria-expanded="false">
                            <div class="rounded-3xl w-full lg:h-40 overflow-hidden">
                                <img class="w-full" src="{{ asset('assets/images/partners--dingo-foundation.png') }}" alt="Australian Dingo Foundation" />
                            </div>
                            <div class="py-3">
