                ...
                <div class="w-full md:w-500px bg-gradient-to-br from-quinary to-senary rounded-3xl p-10">
                    ...
                    <form method="post" action="register">
                        ...
                        <div class="mb-12">
                            ...
                            <input type="email" name="email" class="w-full py-4 py-1 text-white text-3xl focus:outline-none bg-transparent border-solid border-secondary border-b-2" value="{{ old('email') }}" autocomplete="email">
                        </div>
                        <div class="mb-12">
                        ...
                        <div class="mb-12">
                            ...
                            <input type="password" name="c_password" class="w-full py-4 py-1 text-white text-3xl focus:outline-none bg-transparent border-solid border-secondary border-b-2" value="{{ old('email') }}">
                        </div>
