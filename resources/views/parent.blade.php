...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/css/admin-custom.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/css/bootstrap-tagsinput.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/time/jquery.datetimepicker.min.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/css/lib/chosen/chosen.min.css">
    <link href="{{ URL::to('/') }}/assets/summernote/summernote.min.css" rel="stylesheet">
    ...
    <div class="content">
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; {{ now()->year }} Admin Dashboard
                    </div>
...
<script src="{{ URL::to('/') }}/assets/js/init/fullcalendar-init.js"></script>
...
<script src="{{ URL::to('/') }}/assets/js/init/datatables-init.js"></script>
<script src="{{ URL::to('/') }}/assets/js/bootstrap-tagsinput.js" ></script>
<script src="{{ URL::to('/') }}/assets/time/jquery.datetimepicker.full.min.js" ></script>
<script src="{{ URL::to('/') }}/assets/summernote/summernote.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.7.3/dist/Chart.bundle.min.js"></script>
<script src="{{ URL::to('/') }}/assets/js/init/chartjs-init.js"></script>
