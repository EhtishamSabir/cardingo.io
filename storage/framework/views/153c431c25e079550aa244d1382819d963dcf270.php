                ...
                <div class="w-full md:w-500px bg-gradient-to-br from-quinary to-senary rounded-3xl p-10">
                    ...
                    <form method="post" action="login">
                        ...
                        <div class="mb-12">
                            ...
                            <input type="email" name="email" class="w-full py-4 py-1 text-white text-3xl focus:outline-none bg-transparent border-solid border-secondary border-b-2" value="<?php echo e(old('email')); ?>" autocomplete="email" autofocus>
                        </div>
                        <div class="mb-10">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/cardingo.io/public_html/resources/views/pages/login.blade.php ENDPATH**/ ?>