          ...
          <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-6 g-mb-30">
                    <article class="u-shadow-v18 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                        <img class="d-inline-block img-fluid mb-4" src="<?php echo e(URL::to('/')); ?>/Uploads/<?php echo e($wall->url); ?>" alt="<?php echo e($wall->image_name); ?>">
...
</html><?php /**PATH /home/customer/www/cardingo.io/public_html/resources/views/result.blade.php ENDPATH**/ ?>